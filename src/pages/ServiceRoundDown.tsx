...
export default function ServiceRoundDown({ setIsRevealed }: { setIsRevealed?: (val: boolean) => void }) {
  useEffect(() => {
    window.scrollTo(0, 0);
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="font-oswald font-bold text-5xl sm:text-6xl md:text-7xl lg:text-[7rem] text-white tracking-tight uppercase leading-none">
              Round <span className="text-transparent" style={{ WebkitTextStroke: '2px white' }}>Downspouts</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <img 
                src="/copper-downspout.jpeg" 
                alt="Custom Copper Round Downspout Architectural Flow" 
              ...
              <div className="absolute -bottom-6 -left-6 sm:-bottom-8 sm:-left-8 bg-bright-cyan p-6 sm:p-8 shadow-2xl z-20 max-w-[200px]">
                <p className="font-oswald font-bold text-4xl sm:text-6xl text-white leading-none">4"</p>
                <p className="text-white font-bold font-oswald tracking-widest uppercase text-sm mt-2">Smooth Output</p>
              </div>
            </motion.div>
            ...
            >
              <h2 className="font-oswald font-bold text-3xl sm:text-4xl lg:text-5xl text-deep-blue tracking-tight uppercase leading-none mb-6">
                Premium Traditional <br/>
                <span className="text-bright-cyan border-b-4 border-gray-200 pb-2 inline-block mt-2">Drainage Solutions</span>
              </h2>
              
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  While standard aluminum installations often utilize square routing, high-end homes, historic properties, and specialty copper configurations beautifully leverage round downspouts to achieve a traditional, timeless aesthetic without sacrificing flow rates.
                </p>
                <p>
                  The continuous curve of a round 4-inch downspout naturally resists snagging interior debris and forces water into a tight, laminar flow column, minimizing splashing or sputtering at the ground ejection point.
                </p>
                
                <ul className="pt-4 space-y-4">
                  {[
                    "Smooth Cylindrical Water Flow Routing",
                    "Aesthetic Integration With Fine Architecture",
                    "Decreases Interior Debris Catch Points",
                    "Perfect Compliment to Custom Copper Runways"
                  ].map((item, idx) => (
