...
export default function Service6Inch({ setIsRevealed }: { setIsRevealed?: (val: boolean) => void }) {
  useEffect(() => {
    window.scrollTo(0, 0);
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="font-oswald font-bold text-5xl sm:text-6xl md:text-7xl lg:text-[7rem] text-white tracking-tight uppercase leading-none">
              6" Seamless <span className="text-transparent" style={{ WebkitTextStroke: '2px white' }}>Gutters</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <img 
                src="/6-In-Gutter.jpeg" 
                alt="6 Inch K-Style Seamless Gutter Installation" 
              ...
              <div className="absolute -bottom-6 -left-6 sm:-bottom-8 sm:-left-8 bg-bright-cyan p-6 sm:p-8 shadow-2xl z-20 max-w-[200px]">
                <p className="font-oswald font-bold text-4xl sm:text-6xl text-white leading-none">6"</p>
                <p className="text-white font-bold font-oswald tracking-widest uppercase text-sm mt-2">K-Style Profile</p>
              </div>
            </motion.div>
            ...
            >
              <h2 className="font-oswald font-bold text-3xl sm:text-4xl lg:text-5xl text-deep-blue tracking-tight uppercase leading-none mb-6">
                ...
                <span className="text-bright-cyan border-b-4 border-gray-200 pb-2 inline-block mt-2">For Residential</span>
              </h2>
              
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  As the most popular residential gutter dimension across America, the 6-inch K-style system offers robust rainwater management mapping perfectly to standard architectural rooflines.
                </p>
                <p>
                  We fabricate these high-capacity aluminum troughs seamlessly on-site, totally eliminating the vulnerability of spliced joints where standard hardware store sections inevitably fail and leak.
                </p>
                
                <ul className="pt-4 space-y-4">
                  {[
                    "Custom Extruded To Any Run Length On-Site",
                    "Heavy-Gauge Rust-Proof Aluminum",
                    "High-Flow Capacity For Standard Roof Profiles",
                    "Available In Over 30 Distinct Exterior Colors"
                  ].map((item, idx) => (
