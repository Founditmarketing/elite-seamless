...
export default function ServiceGuards({ setIsRevealed }: { setIsRevealed?: (val: boolean) => void }) {
  useEffect(() => {
    window.scrollTo(0, 0);
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="font-oswald font-bold text-5xl sm:text-6xl md:text-7xl lg:text-[7rem] text-white tracking-tight uppercase leading-none">
              Gutter <span className="text-transparent" style={{ WebkitTextStroke: '2px white' }}>Guards</span>
            </h1>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <img 
                src="/gutter-guard-debris-stopper1.jpeg" 
                alt="Premium Gutter Guard Debris Stopper Installed" 
              ...
              <div className="absolute -bottom-6 -left-6 sm:-bottom-8 sm:-left-8 bg-bright-cyan p-6 sm:p-8 shadow-2xl z-20 max-w-[200px]">
                <p className="font-oswald font-bold text-4xl sm:text-6xl text-white leading-none">0%</p>
                <p className="text-white font-bold font-oswald tracking-widest uppercase text-sm mt-2">Clogs or Blockage</p>
              </div>
            </motion.div>
            ...
            >
              <h2 className="font-oswald font-bold text-3xl sm:text-4xl lg:text-5xl text-deep-blue tracking-tight uppercase leading-none mb-6">
                Never Clean Your <br/>
                <span className="text-bright-cyan border-b-4 border-gray-200 pb-2 inline-block mt-2">Gutters Again</span>
              </h2>
              
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  A gutter system is completely useless if water can't flow into it. In pine-heavy regions like Louisiana, exposed troughs inevitably become choked by leaves, needles, and debris.
                </p>
                <p>
                  Our premium gutter guard filtration screens sit seamlessly atop your existing or new extrusion. They act as a physical shield, forcing debris to dry up and blow off while surface tension pulls thousands of gallons of rainwater safely straight into the trough below.
                </p>
                
                <ul className="pt-4 space-y-4">
                  {[
                    "Defeats Fine Debris, Pine Needles, & Leaves",
                    "Eliminates Dangerous Ladder Cleaning Chores",
                    "Prevents Costly Foundation Overflow Damage",
                    "Installs Elegantly Over Any Standard K-Style System"
                  ].map((item, idx) => (
